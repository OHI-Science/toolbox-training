...
- regions are listed in `spatial/regions_list.csv`. We have 8 here.
...
Open `region2017/calculate_scores.r` and let's have a look at its operations. We will run it line-by-line.
...
source('~/github/toolbox-demo/region2017/configure_toolbox.r')
...
If you've tailored a goal model function, you need to make sure that its output is still a data frame, and one that is not grouped. Otherwise, when you run `calculate_scores.r`, you may get a cryptic error. Examples of some of the ones we've seen are: 
