...
- regions are listed in `spatial/regions_list.csv` (and the `spatial/regions_gcs.geojson` spatial file is visible on [GitHub](https://github.com/OHI-Science/toolbox-demo/blob/master/region2016/spatial/regions_gcs.geojson))
