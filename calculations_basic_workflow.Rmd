...
- substituting the Global OHI data layer `ao_access` with new data, which includes saving it in `layers` folder registering it in layers.csv, and 
- rerunning `calculate_scores.r` without modifying the goal model itself
...
When you modify an individual goal model, you will only work within the function's "{ }".
