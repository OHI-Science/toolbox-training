...
- ohicore will calculate pressures and resilience for you. 
- it does so by taking the data layers listed in the matrix (they are data layers similar to those for status: they need values for each region) and calculating scores that will then affect the goals indicated in the matrix.
...
- **(leverge description from http://ohi-science.org/manual/#modifying-pressures-and-resilience)**
...
![](https://docs.google.com/drawings/d/e/2PACX-1vQSotrxrujHlO4iG_WCBifRjOvbzJgoWnKRAB0_Z7dr7GK6PLhYxOVRukQy0l7IuUtQgIxvGR1rBKIp/pub?w=960&h=720)
